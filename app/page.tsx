    ...
    <div className="relative flex flex-col min-h-screen">
      ...
      <section className="relative z-20 flex flex-col items-center justify-center px-4 py-16 md:py-24 lg:py-32 min-h-[80vh]">
        <div className="container mx-auto text-center">
          <div className="inline-flex items-center justify-center px-3 py-1.5 mb-4 md:mb-6 text-xs md:text-sm font-medium rounded-full bg-white/10 text-white backdrop-blur-sm border border-white/20">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-white max-w-4xl mx-auto leading-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-red-600 hover:bg-red-700 text-white px-6 md:px-8 h-10 md:h-12 rounded-full"
            >
              <Link href="/register">
                Join as Reporter
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-8 max-w-4xl mx-auto">
            <div className="flex flex-col items-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <Users className="h-6 w-6 md:h-8 md:w-8 text-red-400 mb-2" />
              <p className="text-white text-xs md:text-sm text-center">Community-Driven</p>
            </div>
            <div className="flex flex-col items-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <AlertTriangle className="h-6 w-6 md:h-8 md:w-8 text-amber-400 mb-2" />
              <p className="text-white text-xs md:text-sm text-center">Real-time Alerts</p>
            </div>
            <div className="flex flex-col items-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <CheckCircle className="h-6 w-6 md:h-8 md:w-8 text-green-400 mb-2" />
              <p className="text-white text-xs md:text-sm text-center">Verified Reports</p>
            </div>
            <div className="flex flex-col items-center p-3 md:p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              <Award className="h-6 w-6 md:h-8 md:w-8 text-blue-400 mb-2" />
              <p className="text-white text-xs md:text-sm text-center">Reward System</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="relative pt-10 px-2">
              {/* Number indicator - made larger and positioned better */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-red-500 text-white flex items-center justify-center text-xl font-bold z-10">
                1
              </div>
            ...
            <div className="relative pt-10 px-2">
              {/* Number indicator - made larger and positioned better */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-amber-500 text-white flex items-center justify-center text-xl font-bold z-10">
                2
              </div>
              {/* Line connector (hidden on mobile) */}
              <div className="absolute top-8 left-1/2 w-0.5 h-full bg-gray-200 -translate-x-1/2 hidden md:block"></div>
            ...
            <div className="relative pt-10 px-2">
              {/* Number indicator - made larger and positioned better */}
              <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-green-500 text-white flex items-center justify-center text-xl font-bold z-10">
                3
              </div>
...
function EmergencyCard({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center text-center p-4 md:p-6 rounded-xl border transition-all duration-300 hover:shadow-lg",
        colorClasses[color],
      )}
    >
