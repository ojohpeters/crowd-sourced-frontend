...
export default function Home() {
  // Sample emergency data for the map preview
  const sampleEmergencies = [
    {
      ...
      type: "accident",
      status: "pending",
      location_url: "https://maps.google.com/?q=6.5244,3.3792",
      created_at: new Date().toISOString(),
    },
    {
      id: 2,
      title: "Building Fire",
      description: "Commercial building on fire",
      type: "fire",
      status: "verified",
      location_url: "https://maps.google.com/?q=6.535,3.39",
      created_at: new Date().toISOString(),
    },
  ]
  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto px-4">
        ...
        {/* Map Preview Section */}
        <section className="py-12 md:py-20">
          <h2 className="text-3xl font-bold text-center mb-12">Join Our Emergency Response Network</h2>
